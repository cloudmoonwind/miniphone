 ...
 */
export const DreamCard = ({ dream, color, rays, rotDeg, starPhase, onClose, onInterpret, onDelete }) => {
        ...
        >
          ...
          >
            <div style={{ position: 'relative', width: 115, height: 115 }}>
              <StarSVG size={120} color={color} rays={rays} rotation={rotDeg} phase={starPhase} />
            </div>
          </div>
